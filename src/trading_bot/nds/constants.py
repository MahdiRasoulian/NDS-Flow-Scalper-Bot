...
ANALYSIS_CONFIG_KEYS = frozenset({
    ...
    'FLOW_EXEC_AGGRESSIVE_MIN',
    'FLOW_EXEC_CONSERVATIVE_MIN',
    'FLOW_EXEC_CONFIRMATION_MIN',
    'FLOW_EXEC_CONSERVATIVE_DEPTH',
    'FLOW_PROXIMITY_GAUSS_SIGMA',
    'FLOW_MOMENTUM_MAX_DIST_ATR',
    'FLOW_MOMENTUM_MAX_DIST_PIPS',
    'FLOW_ALLOW_MOMO_WITHOUT_BASE_SIGNAL',
