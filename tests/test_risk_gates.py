...
def test_sr_gate_fails_closed_when_permission_helpers_unavailable(monkeypatch):
    risk_manager = create_scalping_risk_manager()
    monkeypatch.setattr(risk_manager, "_get_sr_permission_helpers", lambda: (None, None))
